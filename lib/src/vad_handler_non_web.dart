...
class VadHandlerNonWeb implements VadHandlerBase {
  ...
  static const String vadLegacyModelPath = 'packages/vad/assets/silero_vad_legacy.onnx';
  ...
  final _onAudioStreamController = StreamController<Stream<Uint8List>>.broadcast();
  ...
  Future<void> startListening(
    ...
    _onAudioStreamController.add(stream);
  }
